...
Shader "Shader01"
{
	Properties
	{
		...
		[Header(Textures)][SingleLineTexture][Space(10)]_Texture0("Texture 0", 2D) = "white" {}
		_Color("Color", Color) = (0.9716981,0.9716981,0.9716981,0)
		[Header(Properties)][Space(10)]_Occlusion("Occlusion", Float) = 0
		_Metallic("Metallic", Float) = 0
		_Smoothness("Smoothness", Float) = 0
		_Coat("Coat", Float) = 0
		[HDR][Header(Emission)][Space(10)]_Emission("Emission", Color) = (0.9245283,0,0,0)
		_Rimoffset("Rim offset", Float) = 0.33
		[ASEEnd]_EmissionIntensity("Emission Intensity", Float) = 0.09
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float dotResult31 = dot( V , normalWS );
				float4 saferPower48 = max( _Emission , 0.0001 );
				float4 temp_cast_1 = (_EmissionIntensity).xxxx;
				
				surfaceDescription.Albedo = ( _Color * tex2D( _Texture0, uv_Texture0 ) ).rgb;
				surfaceDescription.Normal = float3( 0, 0, 1 );
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = _Coat;
				...
				surfaceDescription.Emission = ( ( 1.0 - saturate( ( dotResult31 + _Rimoffset ) ) ) * pow( saferPower48 , temp_cast_1 ) ).rgb;
...
/*ASEBEGIN
Version=18912
146;277;1563;649;1656.945;505.2591;1.219465;True;True
Node;AmplifyShaderEditor.WorldNormalVector;33;-1941.105,1075.355;Inherit;False;False;1;0;FLOAT3;0,0,1;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.ViewDirInputsCoordNode;32;-1923.658,912.7266;Inherit;False;World;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.DotProductOpNode;31;-1638.442,979.8922;Inherit;True;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-1566.292,1232.277;Inherit;False;Property;_Rimoffset;Rim offset;7;0;Create;True;0;0;0;False;0;False;0.33;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;35;-1349.685,1052.336;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;27;-1245.232,1371.274;Inherit;False;Property;_Emission;Emission;6;2;[HDR];[Header];Create;True;1;Emission;0;0;False;1;Space(10);False;0.9245283,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;46;-1264.653,1603.141;Inherit;False;Property;_EmissionIntensity;Emission Intensity;8;0;Create;True;0;0;0;False;0;False;0.09;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SaturateNode;36;-1112.596,1069.904;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;2;-1596.536,-91.54141;Inherit;True;Property;_Texture0;Texture 0;0;2;[Header];[SingleLineTexture];Create;True;1;Textures;0;0;False;1;Space(10);False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.OneMinusNode;37;-905.1633,1076.941;Inherit;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;15;-1177.608,-362.7631;Inherit;False;Property;_Color;Color;1;0;Create;True;0;0;0;False;0;False;0.9716981,0.9716981,0.9716981,0;0.9716981,0.9716981,0.9716981,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;1;-1219.27,-155.5776;Inherit;True;Property;_TextureSample0;Texture Sample 0;0;0;Create;True;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.PowerNode;48;-873.767,1417.308;Inherit;False;True;2;0;COLOR;0,0,0,0;False;1;FLOAT;1;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;18;-594.418,189.8457;Inherit;False;Property;_Metallic;Metallic;3;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;21;-584.3185,-50.15451;Inherit;False;Property;_Occlusion;Occlusion;2;1;[Header];Create;True;1;Properties;0;0;False;1;Space(10);False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;20;-624.418,270.8457;Inherit;False;Property;_Smoothness;Smoothness;4;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;14;-754.3704,-239.5541;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-599.418,87.8457;Inherit;False;Property;_Coat;Coat;5;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;44;-533.3259,937.9529;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;3;6;44;0
WireConnection;3;7;20;0
WireConnection;3;8;21;0
ASEEND*/
//CHKSM=66B2911BF3F194BCFBAB03075D1EDDE2CBA9C26A